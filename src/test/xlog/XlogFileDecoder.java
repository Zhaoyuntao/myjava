...
public class XlogFileDecoder {
    ...
    public static String PRIV_KEY = "c35033d431749289ea91fc6862a8b9b9ed042b3ed85d809f4d036fc88702437f";
    ...
    public static void ParseFile(String _file, String _outfile, Callback callback) {
        ...
        try {
            ...
            if (-1 == startpos) {
                callback.onFailed("this file is not a xlog");
                return;
            }
...
//                System.out.println(retData.startpos + ":" + retData.lastseq);
            ...
            if (0 == outbuffer.length()) {
                callback.onFailed("out buffer.length() == 0");
                return;
            }

            os = Files.newOutputStream(Paths.get(_outfile));
